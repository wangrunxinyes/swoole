<?php
namespace wrxswoole\Core\Trace\Bean;
...
class TrackerBean
{
    ...
    function updateTrackerToken($token)
    {
        $this->trackerToken = $token;
    }
     ...
     * @return TrackerBean
     */
    function addAttribute($key, string $val = null): TrackerBean
    {
    ...
    function getPointStackMap(): array
    {
        return $this->pointStackMap;
    }

    function addPoint(TrackerPoint $t)
    {
        $this->pointStackMap[$t->getPointName()] = $t;
