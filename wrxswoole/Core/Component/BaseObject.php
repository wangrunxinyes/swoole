...
class BaseObject
{
    ...
    static function configure($object, $properties)
    {
    ...
    static function createObject($type, array $params = [])
    {
        ...
        if (is_callable($type, true)) {
            return (new Container())->invoke($type, $params);
        }
        ...
        throw new \Exception('Object configuration must be an array containing a "class" or "__class" element.');
    }
