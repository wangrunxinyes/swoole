...
use wrxswoole\Core\Database\Component\ConstraintFinderInterface;
use wrxswoole\Core\Database\Component\TableSchema;
use wrxswoole\Core\Helpers\ArrayHelper;
use wrxswoole\Core\Database\Component\IndexConstraint;
use wrxswoole\Core\Database\Component\Expression;
use wrxswoole\Core\Database\Component\Constraint;
use wrxswoole\Core\Database\Component\ForeignKeyConstraint;
use wrxswoole\Core\Database\Component\ConstraintFinderTrait;
 ...
 * @since 2.0
 */
class Schema extends \wrxswoole\Core\Database\Component\Schema implements ConstraintFinderInterface
{
     ...
     * {@inheritdoc}
     */
    public $columnSchemaClass = 'wrxswoole\Core\Database\Component\Mysql\ColumnSchema';
    /**
