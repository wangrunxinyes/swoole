...
abstract class Schema extends BaseObject
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'wrxswoole\\Core\\Database\\Component\IntegrityException'
    ];
     ...
     * @since 2.0.11
     */
    public $columnSchemaClass = 'wrxswoole\\Core\\Database\\Component\ColumnSchema';
     ...
     * @throws \Exception if this method is not supported by the DBMS.
     * @since 2.0.13
     */
    protected function resolveTableName($name)
    {
        throw new \Exception(get_class($this) . ' does not support resolving table names.');
    }
     ...
     * @throws \Exception if a column schema class cannot be created.
     */
     ...
     * @param bool $refresh
     *            whether to fetch the latest available table schemas. If this is `false`,
     ...
     *
     * @param bool $refresh
     *            whether to fetch the latest available schema names. If this is false,
     ...
     * @param bool $refresh
     *            whether to fetch the latest available table names. If this is false,
    ...
    {
        return self::formatException($e, $rawSql);
    }

    static function formatException(\Throwable $e, $rawSql)
    {
        $exceptionClass = '\wrxswoole\Core\Exception\Error\DbException';
        $message = $e->getMessage() . "\nThe SQL being executed was: $rawSql";
        $errorInfo = $e instanceof \PDOException ? $e->errorInfo : null;
        return new $exceptionClass([
            "sql" => $rawSql,
            "errorInfo" => $errorInfo
        ], $message, (int) $e->getCode(), $e);
    }
     ...
     *            metadata type.
     * @param bool $refresh
     *            whether to fetch the latest available table metadata. If this is `false`,
     *            cached data may be returned if available.
