 ...
 */
namespace wrxswoole\Core\Database\Component\Condition;
...
class InCondition implements ConditionInterface
{
     ...
     *
     * @param
     *            string|string[] the column name. If it is an array, a composite `IN` condition
     *            will be generated.
     * @param string $operator
     *            the operator to use (e.g. `IN` or `NOT IN`)
     * @param
     *            array an array of values that [[column]] value should be among. If it is an empty array the generated
