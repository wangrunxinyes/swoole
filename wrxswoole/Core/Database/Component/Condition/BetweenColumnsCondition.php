...
class BetweenColumnsCondition implements ConditionInterface
{
     ...
     *
     * @param
     *            mixed the value to compare against
     * @param string $operator
     *            the operator to use (e.g. `BETWEEN` or `NOT BETWEEN`)
     * @param string|ExpressionInterface $intervalStartColumn
     *            the column name or expression that is a beginning of the interval
     * @param string|ExpressionInterface $intervalEndColumn
