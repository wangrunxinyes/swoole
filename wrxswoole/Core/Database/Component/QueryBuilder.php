...
use wrxswoole\Core\Helpers\StringHelper;
use wrxswoole\Core\Component\BaseObject;
use wrxswoole\Core\Database\Component\Condition\ConditionInterface;
use wrxswoole\Core\Database\Component\Condition\HashCondition;
...
class QueryBuilder extends BaseObject
{
    ...
    /**
     *
     * @var DbManager the database connection.
     */
    public $db;
     ...
     *      ```php
     *      return [
     *      'LIKE' => wrxswoole\\Core\\Database\\Component\condition\LikeCondition::class,
     *      ];
     *      ```
     *     
     ...
     *      ```php
     *      [
     *      wrxswoole\\Core\\Database\\Component\Expression::class => wrxswoole\\Core\\Database\\Component\ExpressionBuilder::class
     *      ]
     *      ```
     ...
     * Extend this method, if you want to change
    ...
    {
        return [
            'NOT' => 'wrxswoole\Core\Database\Component\Condition\NotCondition',
            'AND' => 'wrxswoole\Core\Database\Component\Condition\AndCondition',
            'OR' => 'wrxswoole\Core\Database\Component\Condition\OrCondition',
            'BETWEEN' => 'wrxswoole\Core\Database\Component\Condition\BetweenCondition',
            'NOT BETWEEN' => 'wrxswoole\Core\Database\Component\Condition\BetweenCondition',
            'IN' => 'wrxswoole\Core\Database\Component\Condition\InCondition',
            'NOT IN' => 'wrxswoole\Core\Database\Component\Condition\InCondition',
            'LIKE' => 'wrxswoole\Core\Database\Component\Condition\LikeCondition',
            'NOT LIKE' => 'wrxswoole\Core\Database\Component\Condition\LikeCondition',
            'OR LIKE' => 'wrxswoole\Core\Database\Component\Condition\LikeCondition',
            'OR NOT LIKE' => 'wrxswoole\Core\Database\Component\Condition\LikeCondition',
            'EXISTS' => 'wrxswoole\Core\Database\Component\Condition\ExistsCondition',
            'NOT EXISTS' => 'wrxswoole\Core\Database\Component\Condition\ExistsCondition'
        ];
    }

    /**
     * Contains array of default expression builders.
     * Extend this method and override it, if you want to change
    ...
    {
        return [
            'wrxswoole\\Core\\Database\\Component\Query' => 'wrxswoole\\Core\\Database\\Component\QueryExpressionBuilder',
            'wrxswoole\\Core\\Database\\Component\PdoValue' => 'wrxswoole\\Core\\Database\\Component\PdoValueBuilder',
            'wrxswoole\\Core\\Database\\Component\Expression' => 'wrxswoole\\Core\\Database\\Component\ExpressionBuilder',
            'wrxswoole\Core\Database\Component\Condition\ConjunctionCondition' => 'wrxswoole\Core\Database\Component\Condition\ConjunctionConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\NotCondition' => 'wrxswoole\Core\Database\Component\Condition\NotConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\AndCondition' => 'wrxswoole\Core\Database\Component\Condition\ConjunctionConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\OrCondition' => 'wrxswoole\Core\Database\Component\Condition\ConjunctionConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\BetweenCondition' => 'wrxswoole\Core\Database\Component\Condition\BetweenConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\InCondition' => 'wrxswoole\Core\Database\Component\Condition\InConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\LikeCondition' => 'wrxswoole\Core\Database\Component\Condition\LikeConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\ExistsCondition' => 'wrxswoole\Core\Database\Component\Condition\ExistsConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\SimpleCondition' => 'wrxswoole\Core\Database\Component\Condition\SimpleConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\HashCondition' => 'wrxswoole\Core\Database\Component\Condition\HashConditionBuilder',
            'wrxswoole\Core\Database\Component\Condition\BetweenColumnsCondition' => 'wrxswoole\Core\Database\Component\Condition\BetweenColumnsConditionBuilder'
        ];
    }
     ...
     *            array of builders that should be merged with the pre-defined ones
     ...
     * @param array $params
     *            the parameters to be bound to the generated SQL statement. These parameters will
     ...
     *            of [[wrxswoole\\Core\\Database\\Component\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     *            Passing of [[wrxswoole\\Core\\Database\\Component\Query|Query]] is available since version 2.0.11.
     * @param array $params
    ...
    public function insert($table, $columns, &$params)
    {
        ...
        return 'INSERT INTO ' . $this->db->quoteTableName($table) . (! empty($names) ? ' (' . implode(', ', $names) . ')' : '') . (! empty($placeholders) ? ' VALUES (' . implode(', ', $placeholders) . ')' : $values);
    }
     ...
     * 'visits' => 0,
     * ], [
     * 'visits' => new \wrxswoole\\Core\\Database\\Component\Expression('visits + 1'),
     * ], $params);
     * ```
     *
     * The method will properly escape the table and column names.
    ...
    {
        throw new \Exception($this->db->getDriverName() . ' does not support upsert statements.');
    }
     ...
     *            this parameter recieves a matched constraint list.
    ...
    protected function prepareUpsertColumns($table, $insertColumns, $updateColumns, &$constraints = [])
    {
        ...
        return [
            $uniqueNames,
            $insertNames,
            array_diff($insertNames, $uniqueNames)
        ];
    }
     ...
     *            source column list.
     * @param Constraint[] $constraints
     *            this parameter optionally recieves a matched constraint list.
     *            The constraints will be unique by their column names.
     ...
     * @param array $params
     *            the binding parameters that will be modified by this method
    ...
    public function addPrimaryKey($name, $table, $columns)
    {
        ...
        return 'ALTER TABLE ' . $this->db->quoteTableName($table) . ' ADD CONSTRAINT ' . $this->db->quoteColumnName($name) . ' PRIMARY KEY (' . implode(', ', $columns) . ')';
    }
     ...
     * @param string $type
     *            the column type. The [[getColumnType()]] method will be invoked to convert abstract column type (if any)
    ...
    {
        return 'ALTER TABLE ' . $this->db->quoteTableName($table) . ' DROP COLUMN ' . $this->db->quoteColumnName($column);
    }
     ...
     * @param string $type
     *            the new column type. The [[getColumnType()]] method will be invoked to convert abstract
    ...
    {
        return 'ALTER TABLE ' . $this->db->quoteTableName($table) . ' CHANGE ' . $this->db->quoteColumnName($column) . ' ' . $this->db->quoteColumnName($column) . ' ' . $this->getColumnType($type);
    }
     ...
     * @param string|array $columns
     *            the column(s) that should be included in the index. If there are multiple columns,
    ...
    {
        return ($unique ? 'CREATE UNIQUE INDEX ' : 'CREATE INDEX ') . $this->db->quoteTableName($name) . ' ON ' . $this->db->quoteTableName($table) . ' (' . $this->buildColumns($columns) . ')';
    }
     ...
     * @param string $table
     *            the table that the unique constraint will be added to.
     *            The name will be properly quoted by the method.
     * @param string|array $columns
     *            the name of the column to that the constraint will be added on.
    ...
    public function addUnique($name, $table, $columns)
    {
        ...
        return 'ALTER TABLE ' . $this->db->quoteTableName($table) . ' ADD CONSTRAINT ' . $this->db->quoteColumnName($name) . ' UNIQUE (' . implode(', ', $columns) . ')';
    }
     ...
     *
     * @param string $name
     *            the name of the unique constraint to be dropped.
     *            The name will be properly quoted by the method.
     * @param string $table
     *            the table whose unique constraint is to be dropped.
     *            The name will be properly quoted by the method.
     ...
     *            The name will be properly quoted by the method.
     * @param string $table
     *            the table that the check constraint will be added to.
     *            The name will be properly quoted by the method.
    ...
    {
        return 'ALTER TABLE ' . $this->db->quoteTableName($table) . ' ADD CONSTRAINT ' . $this->db->quoteColumnName($name) . ' CHECK (' . $this->db->quoteSql($expression) . ')';
    }
     ...
     *
     * @param string $name
     *            the name of the check constraint to be dropped.
     *            The name will be properly quoted by the method.
     * @param string $table
     *            the table whose check constraint is to be dropped.
     *            The name will be properly quoted by the method.
     ...
     *            The name will be properly quoted by the method.
     * @param string $table
     *            the table that the default value constraint will be added to.
     *            The name will be properly quoted by the method.
     * @param string $column
     *            the name of the column to that the constraint will be added on.
     *            The name will be properly quoted by the method.
    ...
    {
        throw new \Exception($this->db->getDriverName() . ' does not support adding default value constraints.');
    }
     ...
     *
     * @param string $name
     *            the name of the default value constraint to be dropped.
     *            The name will be properly quoted by the method.
     * @param string $table
     *            the table whose default value constraint is to be dropped.
     *            The name will be properly quoted by the method.
    ...
    {
        throw new \Exception($this->db->getDriverName() . ' does not support dropping default value constraints.');
    }
    ...
    {
        throw new \Exception($this->db->getDriverName() . ' does not support resetting sequence.');
    }
    ...
    {
        throw new \Exception($this->db->getDriverName() . ' does not support enabling/disabling integrity check.');
    }
     ...
     *            the condition specification. Please refer to [[Query::where()]]
     ...
     * to instance of [[wrxswoole\\Core\\Database\\Component\condition\ConditionInterface|ConditionInterface]] according to
    ...
    public function createConditionFromArray($condition)
    {
        if (isset($condition[0])) { // operator format: operator, operand 1, operand 2, ...
            ...
            if (isset($this->conditionClasses[$operator])) {
                ...
                $className = 'wrxswoole\Core\Database\Component\Condition\SimpleCondition';
            }
     ...
     * @param array $operands
     *            the first operand is the column name. The second and third operands
